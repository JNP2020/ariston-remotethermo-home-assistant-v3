...
ARISTON_SENSOR_TYPES: list[AristonSensorEntityDescription] = [
    ...
    AristonSensorEntityDescription(
        ...
        name=f"{NAME} DHW storage temperature",
        icon="mdi:water-thermometer",
        device_class=SensorDeviceClass.TEMPERATURE,
        state_class=SensorStateClass.MEASUREMENT,
        device_features=[DeviceProperties.DHW_STORAGE_TEMPERATURE],
    ...
    AristonSensorEntityDescription(
        ...
        device_features=[DeviceFeatures.HAS_METERING, CustomDeviceFeatures.HAS_GAS],
